...
public class PostController {
    ...
    // 게시글 생성
    @PostMapping(consumes = MediaType.MULTIPART_FORM_DATA_VALUE)   //로그인 구현 후 수정   //Swagger에서 MultipartFile을 받게 하기 위해
    ...
    @GetMapping("/followings")   //로그인 구현 후 수정
    ...
    // 특정 게시글 수정
    @PutMapping(value="/{postId}", consumes = MediaType.MULTIPART_FORM_DATA_VALUE)   //로그인 구현 후 수정
